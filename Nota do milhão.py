...
# In[7]:
        ...
        caminho = 'teste nota do milhão.xlsx' # <- adicione o caminho da planilha
        ...
        for i in range(2, max_linha + 1):
            for j in range(1, max_coluna + 1):
                ...
                driver.find_element_by_xpath(
                    '//*[@id="ctl00_wpMenuLateral_mnuRotinasn3"]/td/table/tbody/tr/td/a').click()
                ...
                # contador, a cada laço add uma linha a variavel
                i = i + 1
